...
const isaManual = 'https://github.com/riscv/riscv-isa-manual/blob/main/src/';

const exto = {
  i:            {ver: 2.1, count: 37,  desc: 'Base Integer Instruction Set', url: isaManual + 'rv32.adoc'},  // Ch.2

  zifencei:     {ver: 2, count: 1, desc: 'Instruction-Fetch Fence', url: isaManual + 'zifencei.adoc'}, // Ch.3
  zihintntl:    {ver: 1,           desc: 'Non-Temporal Locality Hints', url: isaManual + 'zihintntl.adoc'}, // Ch.4
  zihintpause:  {ver: 2,           desc: 'Pause Hint', url: isaManual + 'zihintpause.adoc'}, // Ch.5

  // RV32E and RV64E Base Integer Instruction Sets, Version 2.0 // Ch.6
  e:            {ver: 2,   count: 37,  desc: 'Base Integer Instruction Set with 16 general-purpose registers', url: isaManual + 'rv32e.adoc'},
  ...
  // Ch.9
  m:      {ver: 2,   count: 8,   desc: 'Integer Multiplication and Division', url: isaManual + 'm-st-ext.adoc'},
  zmmul:  {ver: 0.1, count: 4 /* 5 */, desc: 'Integer Multiplication', url: isaManual + 'm-st-ext.adoc#zmmul-extension-version-01'}, // Ch.9.3

  a:      {ver: 2.1, count: 11,  desc: 'Atomic Instructions', url: isaManual + 'a-st-ext.adoc'}, // Ch.10
  zicsr:  {ver: 2,   count: 6,   desc: 'Control and Status Register (CSR) Instructions', url: isaManual + 'zicsr.adoc'}, // Ch.11

  // "Zicntr" and "Zihpm" Counters // Ch.12
  zicntr: {ver: 2.1,             desc: 'Base Counters and Timers', url: isaManual + 'counters.adoc#zicntr-standard-extension-for-base-counters-and-timers'}, // 12.1
  zihpm:  {ver: 2.1,             desc: 'Hardware Performance Counters', url: isaManual + 'counters.adoc#zihpm-standard-extension-for-hardware-performance-counters'}, // 12.2

  f:      {ver: 2.2, count: 26,  desc: 'Single-Precision Floating-Point', url: isaManual + 'f-st-ext.adoc'}, // Ch.13
  d:      {ver: 2.2,             desc: 'Double-Precision Floating-Point', url: isaManual + 'd-st-ext.adoc'}, // CH.14
  q:      {ver: 2.2,             desc: 'Quad-Precision Floating-Point', url: isaManual + 'q-st-ext.adoc'}, // Ch.15
  ...
  zfbfmin: {desc: 'Scalar BF16 FP conversions', count: 2, url: 'https://github.com/riscv/riscv-bfloat16/blob/main/doc/riscv-bfloat16-zfbfmin.adoc'},

  c:      {ver: 2,               desc: 'Compressed Instructions', url: fproxSubstack + 'riscv-c-extension'}, // Ch.18
  // ['rv_c_zihintntl', 'u', 2.0, `HINT Instructions`], // Ch.18.7

  b:      {desc: 'Bit Manipulation'}, // Ch.19
  ...
  zkr:    {desc: 'Entropy Source', url: cryptoDoc + 'scalar/riscv-crypto-scalar-zkr.adoc'},
  ...
  zpn:  {desc: 'Packed-SIMD Instructions'},
  zpsf: {desc: 'Packed-SIMD Instructions'},

  // Vector
  v:    {ver: 1, desc: 'Vector Operations', url: fproxSubstack + 'risc-v-vector-in-a-nutshell'}, // Ch.22
  ...
  zvfbfmin: {desc: 'Vector BF16 FP conversions', count: 2, url: 'https://github.com/riscv/riscv-bfloat16/blob/main/doc/riscv-bfloat16-zvfbfmin.adoc'},
  zvfbfwma: {desc: 'Vector BF16 widening mul-add', count: 1, url: 'https://github.com/riscv/riscv-bfloat16/blob/main/doc/riscv-bfloat16-zvfbfwma.adoc'},
  ...
  zvbb:     {desc: 'Vector Basic Bit-manipulation', count: 10, url: cryptoDoc + 'vector/riscv-crypto-vector-zvbb.adoc'},
  zvbc:     {desc: 'Vector Carryless Multiplication', count: 2, url: cryptoDoc + 'vector/riscv-crypto-vector-zvbc.adoc'},
  ...
  zam:  {ver: 0.1, desc: 'Misaligned Atomics', url: isaManual + 'zam-st-ext.adoc'}, // Ch.23

  // "Zfinx", "Zdinx", "Zhinx", "Zhinxmin": Standard Extensions for Floating-Point in Integer Registers, Version 1.0 // Ch.24
  zfinx:    {ver: 1, desc: 'single-precision Floating-Point in Integer Registers', url: isaManual + 'zfinx.adoc'},
  zdinx:    {ver: 1, desc: 'double-precision Floating-Point in Integer Registers', url: isaManual + 'zfinx.adoc#zdinx'},
  zhinx:    {ver: 1, desc: 'half-precision Floating-Point in Integer Registers', url: isaManual + 'zfinx.adoc#zhinx'},
  zhinxmin: {ver: 1, desc: 'half-precision Floating-Point in Integer Registers (Minimal Subset)', url: isaManual + 'zfinx.adoc#zhinxmin'},

  zfa:      {ver: 0.2, desc: 'Additional Floating-Point Instructions', url: fproxSubstack + 'zfa-even-more-floating-point-operations'}, // Ch.25

  ztso:     {ver: 1, desc: 'Total Store Ordering', url: isaManual + 'ztso-st-ext.adoc'}, // Ch.26
  ...
  zimop:    {ver: '1.0', count: 32, desc: 'May-Be-Operations', url: isaManual + 'zimop.adoc'},
  zcmop:    {ver: '1.0', count: 8, desc: 'Compressed May-Be-Operations Extension', url: isaManual + 'zimop.adoc#zcmop-compressed-may-be-operations-extension-version-10'},

  // https://github.com/riscv/riscv-zawrs
  zawrs:    {ver: 0, desc: 'Wait-on-Reservation-Set'},

  zicond:   {ver: 1, desc: 'Integer Conditional operations', url: fproxSubstack + 'zicond-risc-v-conditional-operations'},

  // 2026-05-26 batch
  zibi:       {ver: 1.0, desc: 'Branch with Immediate Extension', url: 'https://github.com/riscv/zibi/blob/main/src/zibi.adoc'},
  zicfiss:    {ver: 1.0, desc: 'Control-Flow Integrity - Shadow Stack', url: 'https://github.com/riscv/zibi/blob/main/src/unpriv-cfi.adoc#unpriv-backward'},
  zicfilp:    {ver: 1.0, desc: 'Control-Flow Integrity - Landing Pad', url: 'https://github.com/riscv/zibi/blob/main/src/unpriv-cfi.adoc#unpriv-forward'},

  smepmp:     {ver: 1.0, desc: 'Physical Memory Protection Enhancements for Machine mode', url: 'https://github.com/riscv/riscv-isa-manual/blob/main/src/priv/smepmp.adoc'},

  sspmp:      {ver: 1.0, desc: 'Supervisor Physical Memory Protection', url: 'https://github.com/riscv/riscv-spmp/blob/main/sspmp/spmp_spec.adoc'},
  sspmpen:    {ver: 1.0, desc: 'Supervisor Physical Memory Protection Enhancements', url: 'https://github.com/riscv/riscv-spmp/blob/main/sspmp/spmpswitch.adoc'},
  smpmpdeleg: {ver: 1.0, desc: 'Physical Memory Protection Delegation', url: 'https://github.com/riscv/riscv-spmp/blob/main/sspmp/Resource_Sharing.adoc'},

  smcsrind:   {ver: 1.0, desc: 'Indirect CSR Access (Machine Mode)', url: 'https://github.com/riscv/riscv-isa-manual/blob/main/src/priv/smcsrind.adoc'},
  sscsrind:   {ver: 1.0, desc: 'Indirect CSR Access (Supervisor Mode)', url: 'https://github.com/riscv/riscv-isa-manual/blob/main/src/priv/smcsrind.adoc'},

  ssstrict:   {ver: 1.0, desc: 'Strict Execution Environment Constraints', url: 'https://github.com/riscv/riscv-isa-manual/blob/main/src/priv/ssstrict.adoc'},
  smpmpmt:    {ver: 1.0, desc: 'PMP-based Memory Types Extension', url: 'https://github.com/riscv/riscv-spmp/blob/main/sspmp/Interaction_with_other_proposals.adoc'},
  smdbltrp:   {ver: 1.0, desc: 'Machine Double Trap Extension', url: 'https://github.com/riscv/riscv-isa-manual/blob/main/src/priv/smdbltrp.adoc'},
  ssdbltrp:   {ver: 1.0, desc: 'Supervisor Double Trap Extension', url: 'https://github.com/riscv/riscv-isa-manual/blob/main/src/priv/ssdbltrp.adoc'},

  h:        {ver: 1, desc: 'Hypervisor', url: isaManual + 'hypervisor.adoc'},
  ...
  svpbmt:   {ver: 1, desc: 'Page-Based Memory Types'},
  svnapot:  {ver: 1, desc: 'NAPOT Translation Contiguity'},
  svinval:  {ver: 1, desc: 'Fine-Grained Address-Translation Cache Invalidation'}, // Ch.8
  ...
  ssstateen:    {desc: 'Supervisor-mode view of the state-enable'},
  ...
  ssctr:        {desc: 'supervisor-level Control Transfer Records (CTR)', url: 'https://github.com/riscv/riscv-control-transfer-records/tree/main'},
  smctr:        {desc: 'machine-level Control Transfer Records (CTR)', url: 'https://github.com/riscv/riscv-control-transfer-records/tree/main'},

  smrnmi:       {ver: '1.0', count: 1, desc: 'Resumable Non-Maskable Interrupts', url: isaManual + 'rnmi.adoc'},
  smmpm:        {desc: 'Pointer Masking', url: 'https://github.com/riscv/riscv-j-extension/blob/master/zjpm/instructions.adoc'},
  smnpm:        {desc: 'Pointer Masking', url: 'https://github.com/riscv/riscv-j-extension/blob/master/zjpm/instructions.adoc'},
  ssnpm:        {desc: 'Pointer Masking', url: 'https://github.com/riscv/riscv-j-extension/blob/master/zjpm/instructions.adoc'},
  ssqosid:      {desc: 'Quality-of-Service (QoS) Identifiers', url: 'https://github.com/riscv/riscv-ssqosid'},

  // Debug
  sdext:        {ver: '1.0', count: 1, desc: 'Debug mode', url: 'https://github.com/riscv/riscv-debug-spec/blob/main/Sdext.adoc'},
  sdtrig:       {ver: '1.0', desc: 'Debug triggers', url: 'https://github.com/riscv/riscv-debug-spec/blob/main/Sdtrig.adoc'},
  ...
  // SiFive extentions
  xsfvfnrclipxfqf: {
    desc: 'SiFive FP32-to-int8 ranged clip',
    url: 'https://sifive.cdn.prismic.io/sifive/0aacff47-f530-43dc-8446-5caa2260ece0_xsfvfnrclipxfqf-spec.pdf',
    ver: '1.0'
  },
  xsfvfwmaccqqq: {
    desc: 'SiFive Matrix Multiply Accumulate',
    url: 'https://sifive.cdn.prismic.io/sifive/c391d53e-ffcf-4091-82f6-c37bf3e883ed_xsfvfwmaccqqq-spec.pdf',
    ver: '1.0'
  },
  xsfvqmaccqoq: {
    desc: 'SiFive Int8 Matrix Multiplication (4-by-8 and 8-by-4)',
    url: 'https://sifive.cdn.prismic.io/sifive/60d5a660-3af0-49a3-a904-d2bbb1a21517_int8-matmul-spec.pdf',
    ver: '1.1'
  },
  xsfvqmaccdod: {
    desc: 'SiFive Int8 Matrix Multiplication (2-by-8 and 8-by-2)',
    url: 'https://sifive.cdn.prismic.io/sifive/60d5a660-3af0-49a3-a904-d2bbb1a21517_int8-matmul-spec.pdf',
    ver: '1.1'
  }
...
exto.zvkt = {
  desc: 'Vector Data-Independent Execution Latency',
  url: cryptoDoc + 'vector/riscv-crypto-vector-zvkt.adoc',
  items: [exto.zvbb, exto.zvbc]
},
