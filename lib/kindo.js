...
const kindo = {
  ...
  xre: (x) => fieldEnums.xabi[x * 2], // even/paired GPR (register-pair encoding)
  xrce: (x) => fieldEnums.xabic[x * 2], // even/paired compact GPR (x8-x15 pair)
  mtd: (x) => 'mt' + x, // matrix tile register (zvt*)
